...
export const FAQ_TOPICS = [
  ...
  { topic: 'docs', title: '합격증명서와 성적증명서, 달라요?', desc: '두 서류의 차이와 발급 방법',
    keywords: ['합격증명서', '성적증명서', '서류', '차이', '대입전형용', '같은', '같아', '발급', '나이스', '어디서'] },
  { topic: 'naice', title: '나이스 온라인 신청이 뭐예요?', desc: '성적을 대학에 온라인으로 보내는 방법',
    keywords: ['나이스', 'kged', '온라인', '성적 전송', '신청', '차단', '2회차', '우편', '실물'] },
  { topic: 'gedLimit', title: '100점이면 교과 전형 합격 돼요?', desc: '비교내신 구조 때문에 어려울 수 있어요',
    keywords: ['100점', '만점', '교과', '합격', '가능', '등급', '서울', '상위권', '한계'] },
  { topic: 'essay', title: '논술 전형이 왜 유리해요?', desc: '검정고시생에게 논술이 좋은 이유',
    keywords: ['논술', '유리', '내신', '불이익', '없음', '100%', '성균관', '가천', '전략'] },
];
